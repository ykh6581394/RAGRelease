...
def main():
    ...
    with st.sidebar:
        uploaded_files_url =  st.file_uploader("Upload your urls",type=['xlsx','csv'],accept_multiple_files=False)
        crawler = st.button("crawling")
        ...
        if crawler:
            ...
            sel_url = urls_all["url_all"]
            eng_domain = ["world.kbs.co.kr",
